...
var fundoZoom =
    document.getElementById("fundoZoom");

var imagemPapelZoom =
    document.getElementById("imagemPapelZoom");
...
function carregarLayout() {
    ...
    fetch(
        ...
        .catch(function(erro) {
            ...
            console.warn(
                "API indisponível. Usando localStorage.",
                erro
            );
...
function abrirPapel(
    ...
    fundoZoom.classList.add(
        "ativo"
    );


    fundoZoom.setAttribute(
        "aria-hidden",
        "false"
    );
    ...
    setTimeout(
        function() {
            ...
            if (
                ...
                imagemPapelZoom.removeAttribute(
                    "src"
                );
